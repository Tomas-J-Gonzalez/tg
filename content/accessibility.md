...
draft: false
slug: "accessibility"
description: "Our commitment to making this website accessible to all users, including those with disabilities."
layout: "page"
---
...
This website aims to conform to the **Web Content Accessibility Guidelines (WCAG) 2.2 Level AA** standard. WCAG is an internationally recognized set of guidelines for making web content accessible to people with disabilities.
...
- **Content can be presented without requiring horizontal scrolling**
...
- **High contrast modes**: Compatible with system high contrast settings
- **Zoom functionality**: Content remains usable at up to 200% zoom
...
- **WAI-ARIA** - Additional accessibility attributes where needed
- **CSS3** - Responsive design and accessible styling
...
- **Hugo** - Static site generator for performance and accessibility
- **Semantic HTML5** - Proper document structure and landmarks
- **CSS Grid & Flexbox** - Responsive layouts that work across devices
...
3. **Technology updates** - Staying current with accessibility standards and tools
4. **Training and education** - Continuous learning about accessibility best practices
5. **Community engagement** - Participating in accessibility discussions and initiatives
...
This statement was created on 19 December 2024 and will be reviewed annually. The last review date will be updated accordingly.
